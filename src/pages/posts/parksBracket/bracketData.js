...
export const PARKS = {
  ...
  "presidio": {
    ...
    stats: {
      acreage: 1491,
      amenities: ["Baker Beach", "National Cemetery", "Presidio Museum", "Hiking Trails", "Golf Course"],
  ...
  "john-mclaren": {
    ...
    stats: {
      acreage: 313,
      amenities: ["Amphitheater", "Baseball Diamonds", "Walking Trails", "Picnic Areas", "Playgrounds"],
...
export const INITIAL_BRACKET = {
  round16: [
    ...
    { id: "r16-5", parkA: "presidio", parkB: "balboa-park", winner: null },
